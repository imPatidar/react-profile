                    ...
                    <div className="flex flex-wrap">
                        <div className="w-full lg:w-6/12 px-4">
                            ...
                            <h5 className="text-lg mt-0 mb-2 text-gray-700">
                                Find me on any of these platforms, we respond in 1-2 business days.
                            </h5>
                            <div className="mt-6">
                                <a href='https://twitter.com/pankajmpatidar1'>
                                    <button
                                ...
                                <a href='https://linkedin.com/in/impatidar'>
                                    <button
                                ...
                                <a href='https://github.com/impatidar'>
                                    <button
                                ...
                                <a href='https://hackerrank.com/impatidar'>
                                    <button
                                        ...
                                        type="button"
                                    >
                                        <i className="flex fab fa-hackerrank"></i>
                                    </button>
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-wrap items-center md:justify-between justify-center">
                        <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                            <div className="text-sm text-gray-600 font-semibold py-1">
                                Copyright © {new Date().getFullYear()}{" "}Pankaj Patidar{" "}
                            </div>
                        </div>
                    </div>
                </div>
